...
import MagnaWaveImg from '../../Images/MagnaWave.jpg';
        ...
        <div className="magna-wave-container">
            <div className="header-section">
                ...
                <div className="left-column">
                    <h1 className="service-name">MagnaWave Therapy</h1>
                    <p className="service-description">
                        Enhance your horse's performance with our MagnaWave service.
                    </p>
                    <button className="book-now-button" onClick={() => navigate("/Equine-Edge-Sports-Therapy/schedule/magnawave")}>Book Now</button>
                </div>
