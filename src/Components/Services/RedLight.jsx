...
import '../../Styling/RedLight.css'; // Assuming you have a CSS file for styles
import RedLightImg from '../../Images/RedLight.jpg';
        ...
        <div className="magna-wave-container">
            <div className="header-section">
                ...
                <div className="left-column">
                    <h1 className="service-name">Redlight Therapy</h1>
                    <p className="service-description">
                        Enhance your horse's performance with our Redlight service.
                    </p>
                    <button className="book-now-button" onClick={() => navigate("/Equine-Edge-Sports-Therapy/schedule/redlight")}>Book Now</button>
                </div>
